...
class ResNet_pu(nn.Module):
    def __init__(self, block, num_blocks, no_class=10, batch_norm=False,try_assert=True, old_etf=None):
        ...
        self.classifier_new = ETF_Classifier(
            feat_in=512*block.expansion, 
